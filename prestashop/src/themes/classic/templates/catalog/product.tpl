 ...
 * https://o...content-available-to-author-only...e.org/licenses/AFL-3.0
 ...
 * needs please refer to https://d...content-available-to-author-only...p.com/ for more information.
 *}
...
{block name='content'}
  <section id="main" class="tuttu-product-page">
    ...
    <div class="row product-container js-product-container">
      ...
      {* PRAWA KOLUMNA – INFO + KOSZYK *}
      <div class="col-md-6 tuttu-right-col">
          ...
          <div class="product-actions js-product-actions">
            {block name='product_buy'}
              <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
                ...
                {* 6. PRZYCISK „KUP TERAZ” – TYLKO WIZUALNIE, DZIAŁANIE JAK DODAJ DO KOSZYKA *}
                ...
                {* 7. DODATKOWE INFO POD PRZYCISKAMI *}
